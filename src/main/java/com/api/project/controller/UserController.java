...
import com.zwh.common.model.vo.UserVO;
...
public class UserController {
    ...
    public BaseResponse<Boolean> updateUserInfo(@RequestBody UserUpdateSecret secret, HttpServletRequest request) {
        boolean result = userService.updateUserInfo(secret, request);
